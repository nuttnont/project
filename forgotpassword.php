                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="shadow-lg p-3 mb-5 bg-body rounded">
                                <form>
                                    <h2>
                                        <p style="color: #0f1176;" class="text-center">ลืมรหัสผ่าน</p>
                                    </h2>
                                    <div class="mb-3">
    ...
    <label class="form-check-label" for="exampleCheck1">Check me out</label>
                                    ...
                                    <div class="d-grid gap-2">
                                        <button style="background: #409d28;border: none;" type="submit"
                                            class="btn btn-primary btn-lg btn-block btn-success">ส่งอีเมล</button>
                                    </div>
                                </form>
                            </div>
                            <h3>
                                <p for="reg" class="text-center"><a style="color: #409d28;" href="index.php" class="reg"
