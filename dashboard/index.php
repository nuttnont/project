                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <select class="form-control" id="month">
                            ...
                            <?php
                            $query2 = " SELECT * FROM mineral_production,mineral,license WHERE mineral_production.Mineral_Id = mineral.Mineral_Id AND mineral_production.Mine_Id = license.Mine_Id AND license.Users_id = '$sem' GROUP BY Month,Year ORDER BY Month DESC,Year DESC";
                ...
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        <select class="form-control" id="year">
                            <!-- <option value=''>เดือน</option> -->
                            <?php
                            $query2 = " SELECT DISTINCT Year FROM mineral_production,mineral,license WHERE mineral_production.Mineral_Id = mineral.Mineral_Id AND mineral_production.Mine_Id = license.Mine_Id AND license.Users_id = '$sem' ORDER BY cast(Year as int) DESC";
                            $result2 = mysqli_query($conn, $query2);
