...
if (isset($_GET['month'],$_GET['year'],$_GET['mineid'],$_GET["license"],$_GET["version"])) {
    $month = $_GET['month'];
    $year = $_GET['year'];
    $mineid = $_GET['mineid'];
                                            ...
                                            <div class="table-wrapper-scroll-y my-custom-scrollbar"
                                                ...
                                                <table id="tableM" name="tableM"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php 
                                                    $count = 1;
                                                    $sql11 = "SELECT * FROM minning_machine,machine WHERE machine.Machine_Id = minning_machine.Machine_Id AND minning_machine.Mine_Id = $mineid AND minning_machine.Month = $month AND minning_machine.YEAR = $year AND minning_machine.version = $version "; 
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr valign="top" id="<?php echo $count ?>">
                                                            <td class="machine_type<?php echo $count ?>">
                                                                <?php echo $row['Machine_Type'] ?> </td>
                                                            <td class="machine_brand<?php echo $count ?>">
                                                                <?php echo $row['Machine_Brand'] ?> </td>
                                                            <td class="machine_model<?php echo $count ?>">
                                                                <?php echo $row['Machine_Model'] ?> </td>
                                                            <td class="Machine_number<?php echo $count ?>">
                                                                <?php echo $row['Amount'] ?> </td>
                                                            <td style="display: none;"
                                                                class="machine_id<?php echo $count ?>">
                                                                <?php echo $row['Machine_Id'] ?> </td>
                                                            <td><button type="button" href="javascript:void(0);"
                                                                    class="remCF btn btn-danger">ลบ</button></td>
                                                        </tr>
                                                ...
                                                <div class="table-wrapper-scroll-y my-custom-scrollbar"
                                                    ...
                                                    <table id="tableMS" name="tableMS"
                                                        ...
                                                        <tbody>
                                                            <?php 
                                                    $count2 = 1;
                                                    $sql12 = "SELECT * FROM machine_t WHERE  Mine_Id = $mineid AND Month = $month AND YEAR = $year AND version = $version "; 
                                                    ...
                                                    while($row =  mysqli_fetch_array($result12)){
                                                        ...
                                                        // echo '<script>alert("'.$row['Machone_Type'].'")</script>';
                                                    ?>
                                                            <tr valign="top" id="<?php echo $count2 ?>">
                                                                <td class="other_name<?php echo $count2 ?>">
                                                                    <?php echo $row['Machine_ot'] ?> </td>
                                                                <td class="other_value<?php echo $count2 ?>">
                                                                    <?php echo $row['Machine_hp'] ?> </td>
                                                                <td><button type="button" href="javascript:void(0);"
                                                                        class="remCF btn btn-danger">ลบ</button></td>
                                                            </tr>
                                ...
                                <div class="table-wrapper-scroll-y my-custom-scrollbar"
                                    ...
                                    <table id="table3" name="table3"
                                        ...
                                        <tbody>
                                            <?php 
                                                    $count3 = 1;
                                                    $sql12 = "SELECT * FROM minning_machine,machine WHERE machine.Machine_Id = minning_machine.Machine_Id AND minning_machine.Mine_Id = $mineid AND minning_machine.Month = $month AND minning_machine.YEAR = $year AND minning_machine.version = $version "; 
                                            ...
                                            <tr valign="top" id="<?php echo $count3 ?>">
                                                <td class="mineral<?php echo $count3 ?>">
                                                    <?php echo $row['Mineral_Id'] ?> </td>
                                                <td class="condition<?php echo $count3 ?>">
                                                    <?php echo $row['Mp_condition'] ?> </td>
                                                <td class="produce<?php echo $count3 ?>">
                                                    <?php echo $row['Mp_Quantity'] ?> </td>
                                                <td class="quantity<?php echo $count3 ?>">
                                                    <?php echo $row['Mp_Quantity'] ?> </td>
                                                <td><button type="button" href="javascript:void(0);"
                                                        class="remCF btn btn-danger">ลบ</button></td>
                                            </tr>
...
$(document).ready(function() {
    ...
    $("#butsendM").click(function() {
        ...
        $("#tableM").append('<tr valign="top" id="' + newid + '">\n\
            ...
            <td style="display: none;" class="machine_id' + newid + '">' + $("#machine_model option:selected").val() +
            '</td>\n\
            <td><button type="button" href="javascript:void(0);" class="remCF btn btn-danger">ลบ</button></td>\n\</tr>'
        );
    ...
    $("#butsave").click(function() {
        ...
        for (var i = 1; i <= lastRowId2; i++) {
            explosiveselected.push($(".explosiveselected" + i)
                .html()); /* pushing all the names listed in the table */
            explosive_input.push($(".explosive_input" + i).html());
            explosiveRadio.push($(".explosiveRadio" + i)
                .html()); /* pushing all the ages listed in the table */
        }

        for (var i = 1; i <= lastRowId5; i++) {
            Machine_number.push($(".Machine_number" + i)
                .html()); /* pushing all the ages listed in the table */
            machine_id.push($(".machine_id" + i)
                .html()); /* pushing all the names listed in the table */
        }
        ...
        for (var i = 1; i <= lastRowId6; i++) {
            ...
            other_value.push($(".other_value" + i)
                .html()); /* pushing all the ages listed in the table */
        }
